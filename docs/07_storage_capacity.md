...
**미완:** 3ch 1h YOLO soak + `cam-acq-memory-profile` 3ch (`11_field_pending_work.md` §3).
...
**3ch RAM/VRAM 재실측:** YOLO 1h soak과 동시 — `11_field_pending_work.md` §3.2.
...
| B | 3ch | 4.3 GB | **~8–10 GB** (추정) | 여유 증가 |
| B | 3ch RGB ring | 12.8 GB | **~16–18 GB** (추정) | **실측 필요** |
